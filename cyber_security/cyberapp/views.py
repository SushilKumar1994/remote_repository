...
data = pd.read_csv('E:\\djangoproject\\cyber_security\\cyberapp\\Train_data.csv')
...
def Logistic(request):
    ...
    return render(request, 'logistic.html',dic_LR)
...
def svm(request):
    ...
    dic_svm = {'s': cm_svm, 's1': accuracy_svm}
    return render(request, 'svm.html',dic_svm)
...
def random(request):
    ...
    return render(request,'random.html',dic_RF)
